...
export default function getButtonVariants() {
  return {
    ...
    "gray": {
      ...
      "backgroundColor": "--grey-grey_600",
      "backgroundColorHover": "--grey-grey_700",
      "textColor": "--grey-white",
      "textColorHover": "--grey-white",
      "borderColor": "--grey-grey_600",
      "borderColorHover": "--grey-grey_700",
      "borderRadius": "50",
      "paddingLeftRight": "32",
      "paddingBottomTop": "14",
      "borderWidth": "2",
    ...
    "gray-light": {
      "componentVariantTitle": "Gray Light",
      "backgroundColor": "--grey-grey_100",
      "backgroundColorHover": "--grey-grey_200",
      "textColor": "--grey-grey_700",
      "textColorHover": "--grey-grey_800",
      "borderColor": "--grey-grey_100",
      "borderColorHover": "--grey-grey_200",
      "borderRadius": "50",
      "paddingLeftRight": "32",
      "paddingBottomTop": "14",
      "borderWidth": "2",
    ...
    "header-style": {
      "componentVariantTitle": "Header Style (Purple)",
    ...
    "transparent-purple": {
      "componentVariantTitle": "Transparent Purple",
      "backgroundColor": "transparent",
      "backgroundColorHover": "--grey-white-40",
